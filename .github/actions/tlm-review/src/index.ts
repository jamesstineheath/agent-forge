    ...
    if (tier1Files.length > 0) {
      ...
      await octokit.rest.pulls.createReview({
        ...
        body: [
          ...
          fileList,
          '',
          '**Option A:** Merge as-is — the changes look correct and you trust the implementation.',
          '**Option B:** Request a more targeted change — ask the executor to narrow the scope.',
          '',
          'Auto-merge is disabled. Please review and decide.',
          '',
